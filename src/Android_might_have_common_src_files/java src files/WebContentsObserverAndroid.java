...
public abstract class WebContentsObserverAndroid {
	...
	Log.i("chromeInfo" , "Page finished Loading: " + url);
    }
	...
	Log.e("chromeInfo" , "Page failed to Load: " + failingUrl);
    }
	...
	Log.i("chromeInfo" , "Frame navigated from : " + baseUrl + "to : " + url);
    }
	...
	Log.i("chromeInfo" , "Load started for frame: " + frameId + "on :" + validatedUrl);
}
	...
	Log.i("chromeInfo" , "Fram finished Loading: " + frameId + "on : " + validatedUrl);
}
