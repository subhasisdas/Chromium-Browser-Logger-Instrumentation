...
public class ContentViewCore
    ...
    public void initialize(ViewGroup containerView, InternalAccessDelegate internalDispatcher,
	    ...
	    Log.i("chromeInfo","Content Description :"+ contentDescription);
        }
	...
	Log.i("chromeInfo","EvEnt Loading ContentView URL :"+params.mUrl.toString());
	...
	Log.i("chromeInfo","Event Stop Loading contentView URL");
	...
	//Log.i("chromeInfo" , "Executing Script on : " + getUrl());
}
