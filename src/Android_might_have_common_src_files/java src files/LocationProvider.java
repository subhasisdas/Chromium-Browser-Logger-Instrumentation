...
class LocationProvider {
    ...
    private static class LocationProviderImpl
	    ...
	    Log.i("chromeInfo" , "Started listening for location updates" );
	    ...
	    Log.i("chromeInfo" , "Stopped listening for location updates" );
        }
	    ...
	    Log.i("chromeInfo" , "Location changed" );
        }
	    ...
	    Log.i("chromeInfo" , "Registering for location updates" );
            assert !mIsRunning;
            mIsRunning = true;
