...
public class LoadUrlParams {
	...
	Log.i("chromeInfo","Load Url Event registered!");
	Log.i("chromeInfo","URL :"+mUrl);
    }
    ...
    public static LoadUrlParams createLoadDataParams(
        ...
        Log.i("chromeInfo ","URL Event Registered :" + dataUrl.toString());
        Log.i("chromeInfo ","LoadType :" + LoadUrlParams.LOAD_TYPE_DATA);
	return params;
    }
